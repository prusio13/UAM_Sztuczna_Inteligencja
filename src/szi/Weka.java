...
public class Weka {
    ...
    public static void testClassifier() throws Exception{
        Instances trainInstances = new Instances(new BufferedReader(new FileReader(System.getProperty("user.dir")+"/resorces/plony.arff")));
        trainInstances.setClassIndex(trainInstances.numAttributes()-1);
        Instances testInstances = new Instances(new BufferedReader(new FileReader(System.getProperty("user.dir")+"/resorces/plony test.arff")));
