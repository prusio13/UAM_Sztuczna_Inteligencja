...
public class UnknownPlant extends Plant {
    ...
    public UnknownPlant() {
        this(generator.nextFloat() * 100, generator.nextFloat() * 10,
                PlantClassifier.getColors()[generator.nextInt(PlantClassifier.getColors().length - 1)],
                PlantClassifier.getCrops()[generator.nextInt(PlantClassifier.getCrops().length - 1)]);
    }
    ...
    public String toString() {
        return (Double.toString(height) + ", " + Double.toString(size) + ", " + color + ", " + crop + Double.toString(
                getValue()));
    }
}
